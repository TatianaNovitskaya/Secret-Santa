...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2024-11-03T21:53:51.503Z',
        updatedAt: '2024-11-03T21:53:51.503Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2024-11-03T21:53:51.503Z'))
    expect(result.updatedAt).toEqual(new Date('2024-11-03T21:53:51.503Z'))
  })
